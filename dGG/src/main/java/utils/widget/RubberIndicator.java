...
//    private static final int OUTER_CIRCLE_RADIUS = 50;
    ...
    private static final int LARGE_CIRCLE_RADIUS = 12;
    private static final int OUTER_CIRCLE_RADIUS = 25;

    private static final int BEZIER_CURVE_ANCHOR_DISTANCE = 15;
